...
function InstitutionalSales() {
  return (
    ...
    <article className=' lg:w-[50%] w-full px-2 lg:px-4'>
      <h2 className="lg:ml-4 self-start lg:mt-28 mt-14 mb-6 text-2xl md:text-4xl lg:text-5xl font-bold p-2 text-center border-l-8 border-red-700">VENTAS INSTITUCIONALES</h2>

      <article className="flex flex-col justify-around pl-2 lg:pl-4  min-h-[70%]">
